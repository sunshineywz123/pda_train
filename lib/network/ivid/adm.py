...
class AdmUnet2d(nn.Module):
    ...
    def forward(self, x, times, classes=None, encoder_hidden_states=None):
        """
...
class AdmNotimeUnet2d(nn.Module):
    """
    The full UNet model with attention and timestep embedding.
    ...
    def forward(self, x, times=None, classes=None, encoder_hidden_states=None):
        """
        Apply the model to an input batch.
