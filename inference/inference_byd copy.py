...
# depth_map = proj_pcd2frame_getdepth(K,pts,image)[:,:,0]
# import pdb;pdb.set_trace()
depth_map=np.load('lidar.npy')/100
lowres_depth=depth_map


o3d.io.write_point_cloud('input.ply',generate_point_cloud(image,lowres_depth,K))
...
o3d.io.write_point_cloud('input2.ply',generate_point_cloud(image,lowres_depth,K))
o3d.io.write_point_cloud('predict.ply',generate_point_cloud(image,depth,K))
