...
from lib.utils.geo.triangulation import triangulate_optim
...
def triangulate_point(Ts_w2c, c_p2d, **kwargs):
    from lib.utils.geo.triangulation import triangulate_persp

    print("Deprecated, please import from lib.utils.geo.triangulation")
    return triangulate_persp(Ts_w2c, c_p2d, **kwargs)


def triangulate_point_ortho(Ts_w2c, c_p2d, **kwargs):
    from lib.utils.geo.triangulation import triangulate_ortho
