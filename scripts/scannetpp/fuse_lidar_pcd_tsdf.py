...
def main(args):
    ...
    for idx, name in tqdm(enumerate(names)):
        ...
        frustum_block_coords = vbg.compute_unique_block_coordinates(
            depth, depth_intrinsic, extrinsic, depth_scale=depth_scale, depth_max=args.max_depth)
        vbg.integrate(frustum_block_coords, depth, img, depth_intrinsic, color_intrinsic, extrinsic, depth_scale, args.max_depth)
