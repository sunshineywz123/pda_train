...
def get_metadata(scene):
    ...
    rgb_files = [depth_file.replace('render_depth', 'images/iphone').replace('.png', '.jpg') for depth_file in depth_files]
...
def parse_args():
    ...
    parser.add_argument('--tag', type=str, default='meshdepth_0614')
