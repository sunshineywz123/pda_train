...
def parse_args():
    ...
    parser.add_argument('--input_depth_path', type=str, default='/mnt/bn/haotongdata/home/linhaotong/projects/pl_htcode/data/pl_htcode/preview/outputs/depth_estimation/june_depthanythingmetric_scannetpp_overfit_and_hypersim/results/ep4/orig_pred')
    ...
    parser.add_argument('--output_ply_path', type=str, default='56a_pred_tsdf.ply')
...
def main(args):
    ...
    for idx, name in tqdm(enumerate(names)):
        ...
        depth_path = join(args.input_depth_path, 'images__iphone__' + name[7:-4] + '.npz')
