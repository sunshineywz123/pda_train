...
def main(args):
    ...
    depth_path = join('/'.join(args.input_path.split('/')[:-1]), 'iphone/render_depth')
    ...
    output_ply_path = join(args.input_path, 'depth/v1/pcd_faro/points.ply')
