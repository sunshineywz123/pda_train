...
def main(args, exp, tag):
    # cams, images, points = read_model(args.colmap_path)
    source_ply_path  = join(args.input_path, f'plys/{exp}_{tag}.ply')
    target_ply_path = join(args.input_path, f'plys/lidar_tsdf.ply')
    global_voxel_size = 0.2
    fine_voxel_size = 0.05

    # source_ply_path = join('/Users/linhaotong',  f'{exp}_{tag}.ply')
    source_ply_path = join('/Users/linhaotong',  f'lidar_tsdf.ply')
    target_ply_path = join('/Users/linhaotong', f'mesh_aligned_0.05.ply')
...
if __name__ == '__main__':
    ...
    for scene in scenes:
        ...
        depth_path_dir = f'/mnt/bn/haotongdata/home/linhaotong/workspaces/pl_htcode/outputs/depth_estimation/june_depthanythingmetric_scannetpp_0614_hypersim/results/{scene}_0703/orig_pred'
