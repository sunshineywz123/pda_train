...
def parse_args():
    ...
    parser.add_argument('--tag', type=str, default='zipdepth_meshdepth_sem_0614')
...
def main(args):
    ...
    all_meta_data = {'rgb_files': [], 'depth_files': [], 'lowres_files': [], 'mesh_depth_files': [], 'sem_files': []}
    train_meta_data = {'rgb_files': [], 'depth_files': [], 'lowres_files': [], 'mesh_depth_files': [], 'sem_files': []}
    train_scenes = []
    ...
    test_meta_data = {'rgb_files': [], 'depth_files': [], 'lowres_files': [], 'mesh_depth_files': [], 'sem_files': []}
    test_scenes = []
