...
def main(
    colmap_path: Path = Path("/mnt/bn/haotongdata/test/BD_Test/RenderingOutput/CameraComponent/sparse/0_aligned"),
    images_path: Path = Path("/mnt/bn/haotongdata/test/BD_Test/RenderingOutput/CameraComponent/ColorImage"),
    ...
    def visualize_colmap() -> None:
        ...
        for img_id in tqdm(img_ids):
            ...
            if cam.model != "PINHOLE" and cam.model != "SIMPLE_PINHOLE":
...
#     parser.add_argument('--colmap_path', type=str, default='/mnt/bn/haotongdata/test/BD_Test/RenderingOutput/CameraComponent/sparse/0_aligned')
#     parser.add_argument('--image_path', type=str, default='/mnt/bn/haotongdata/test/BD_Test/RenderingOutput/CameraComponent/ColorImage')
