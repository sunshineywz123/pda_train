...
def parse_args():
    ...
    parser.add_argument('--pred_path', type=str, default='/mnt/bn/haotongdata/home/linhaotong/projects/sfm_depth_completion/sfm/outputs/marigold-cluster-sfm/train_mixed_8gpu_3nn/results/tat_sfm_min_max_di0.2_e37')
    parser.add_argument('--depth_type', type=str, default='distance_median')
    parser.add_argument('--colmap_path', type=str, default='/mnt/bn/haotongdata/Datasets/tat/test_scenes/Meetingroom/NeuralSfM_DKM_coarse_only_round-1_pri_pose/colmap_refined')
    parser.add_argument('--gt_path', type=str, default='/mnt/bn/haotongdata/Datasets/tat/test_scenes/Meetingroom/images')
    parser.add_argument('--normalized_scale_factor', type=float, default=1.)   
...
def main(args):
    ...
    for idx, name in tqdm(enumerate(names)):
        ...
        depth = cv2.resize(depth, (cam_width, cam_height), interpolation=cv2.INTER_NEAREST)
