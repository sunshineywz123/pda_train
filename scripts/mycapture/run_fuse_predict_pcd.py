...
def main(args):
    ...
    depth_path = join(args.workspace_path, args.exp_name, 'results', args.scene, 'orig_pred')
    cams, images, points3d = read_model(colmap_path)

    output_ply_path = join(args.workspace_path, args.exp_name, 'results', args.scene, 'plys', 'output.ply')
...
def parse_args():
    ...
    parser.add_argument('--exp_name', type=str, default='june_depthanythingmetric_scannetpp_0614_hypersim')
